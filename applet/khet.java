...
class Esfinge extends Pieza {
  ...
  public void definirLaser(int pposX, int pposY, Juego pjuego){
...
class Juego{
  ...
  public void laserJugador1(Pieza ppieza){
    piezaLaserJugador1 = ppieza;
  }
  
  public void laserJugador2(Pieza ppieza){
...
class Laser {
  ...
  public void setLaser(int pposX, int pposY, String pdir){
    originalDir = pdir;
...
class Pieza {
  ...
  public void setPieza(int pposX, int pposY) {
    posXTablero = pposX;
    posYTablero = pposY;
    posX = pposX * 50;
    posY = pposY * 50;
  ...
  public int setDirToDegree(String pdir){
    if(pdir == "O") {
      return 0;
    }
    if(pdir == "E") {
  ...
  public String setDegreeToDir(int pdegree){
    if(pdegree == 0) {
      return "O";
    }
    if(pdegree == 180) {
